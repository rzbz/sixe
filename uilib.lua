...
local NAME = _G.SIXE_NAME
local GAME_NAME = _G.SIXE_GAME_NAME
...
local function offsetToScale(guiObject, useViewport, parent)
  print("offsetToScale", guiObject.Size)
  local newSize
...
function DiscordLib:Window(text)
  ...
  offsetToScale(MainFrame, true)
	...
	Userpad.Position = UDim2.new(0.106243297, 0, 13, 0)
  ...
  function ServerHold:Destroy()
	...
	function ServerHold:Server(text, img, isRunning, onServerClick)
		local fc = false
    ...
    ServerWhiteFrame.Visible = isRunning or false
